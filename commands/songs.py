...
class Songs(commands.Cog):
    ...
    async def support(self, ctx):
        embed = discord.Embed(title="<:blushhh:1177511091278987354> Share your favourite songs!", description="We want to hear the beats that make your heart skip! Click the button below and share the link to your favorite songs.\n\n( Spotify • Youtube • SoundCloud )", color=0x959FFF)
...
class SongsView(View):
    ...
    @discord.ui.button(label='Share', style=discord.ButtonStyle.blurple, emoji="<:share:1175064192072548512>", custom_id="sharebtn")
